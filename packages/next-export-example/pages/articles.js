...
const ARTICLES = [
  ...
  {
    id: 'check-the-weather-before-you-ride',
    title: 'Check the Weather Before You Ride',
    body: [
      'Weather changes affect hydration, energy, and recovery. Check temperature, humidity, and wind before you ride so you can plan the right warm-up.',
      'In heat or humidity, shorten work periods and prioritize hydration and electrolytes. In cold or wind, extend warm-up time and keep muscles moving.',
      'Log weather conditions alongside your ride notes. Over time, it becomes a powerful tool for understanding performance and recovery patterns.'
    ]
  },
  {
        ...
        {ARTICLES.map(article => (
          <section
            ...
            style={{
              ...
              border: '1px solid #e6d9c8',
              background: '#fffaf4',
              boxShadow: '0 16px 30px rgba(37, 28, 20, 0.1)'
            }}
          >
